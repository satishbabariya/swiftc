...
namespace swift {
    ...
    class LangOptions final {
        public:
            /// Constructs language options for the specified target.
            explicit LangOptions(llvm::Triple target,
                                 std::optional<llvm::Triple> targetVariant = std::nullopt)
            ...
            /// Returns the target variant triple.
            const std::optional<llvm::Triple> &getTargetVariant() const { return TargetVariant; }
